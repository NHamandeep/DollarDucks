...
//         title: (
//           <>
//           News <span className="text-gray-500 ml-20">Coming Soon</span>
//           </>
//         ),
//         link: "/news",
//         icon: <FiGlobe />,
...
//         title: (
//           <>
//             Podcast <span className="text-gray-500 ml-15">Coming Soon</span>
//           </>
//         ),
//         link: "/podcast",
//         icon: <FiMic />,
...
//         title: (
//           <>
//             Academy <span className="text-gray-500 ml-13">Coming soon</span>
//           </>
//         ),
...
const Navbar = () => {
  ...
  const dropdownItems = {
    ...
    Hub: [
      { title: <>AI</>, link: "/ai", icon: <GiArtificialIntelligence /> },
      { title: <>Merchandise</>, link: "/merchandise", icon: <FaStoreAlt /> },
      {
        title: (
          <>
            News <span className="text-gray-500 ml-20">Coming Soon</span>
      ...
      <nav className="bg-black text-white shadow-md fixed w-screen top-0 z-50">
        <div className="w-full max-w-[1440px] mx-auto flex justify-between items-center py-4 px-6">
          ...
          <div className="hidden lg:flex space-x-4 items-center">
            {/* Social Icon Buttons */}
            <Link
              to="https://github.com/dollarducks"
              target="_blank"
            ...
            <Link
              to="https://buymeacoffee.com/dollarducks"
              target="_blank"
              className="bg-white text-black rounded-full p-2 hover:bg-yellow-400 transition"
            >
          ...
          <div className="lg:hidden bg-black p-4 absolute top-16 left-0 w-full shadow-lg z-40">
            <ul className="flex flex-col space-y-4 text-center">
              ...
              <div className="flex items-center justify-between w-full gap-4 mt-4">
                <Link
                  to="/BookaDemo"
                  className="bg-yellow-400 text-black px-6 py-2 rounded-lg hover:bg-yellow-300 transition-all duration-300 w-full text-center"
                >
                  Book a Demo
                </Link>
                <DarkModeToggle />
