...
// Import local images
import tattooImg from '../assets/ProfessionalsExperts/tattoo.webp';
import financialImg from '../assets/ProfessionalsExperts/financial.jpg';
import legalImg from '../assets/ProfessionalsExperts/legal.jpg';
import realEstateImg from '../assets/ProfessionalsExperts/realstate.webp';
import salonImg from '../assets/ProfessionalsExperts/salon.jpeg';
import therapistImg from '../assets/ProfessionalsExperts/therapist.jpg';

const professionals = [
  { id: 1, name: 'Tattoo Artist', description: 'Creating unique, permanent art that tells a story.', image: tattooImg },
  { id: 2, name: 'Financial Consultant', description: 'Guiding businesses and individuals to manage money wisely.', image: financialImg },
  { id: 3, name: 'Legal Advisor', description: 'Providing expert legal guidance and ensuring compliance.', image: legalImg },
  { id: 4, name: 'Real Estate Agent', description: 'Helping clients buy, sell, and invest in properties.', image: realEstateImg },
  { id: 5, name: 'Salon Specialist', description: 'Transforming looks with hair, beauty, and skincare services.', image: salonImg },
  { id: 6, name: 'ABA Therapist', description: 'Supporting individuals with behavioral therapy and skill-building.', image: therapistImg },
];
