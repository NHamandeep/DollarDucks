...
import DuckImage from "../assets/dao5.png";
import MetaGoogleAds1 from "../assets/MetaGoogleAds/slider1.png";
import MetaGoogleAds2 from "../assets/MetaGoogleAds/slider2.png";
import MetaGoogleAds3 from "../assets/MetaGoogleAds/slider3.png";
import MetaGoogleAds4 from "../assets/MetaGoogleAds/slider4.png";
import MetaGoogleAds5 from "../assets/MetaGoogleAds/slider5.png";
import MetaGoogleAds6 from "../assets/MetaGoogleAds/slider6.png";
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mt-15 sm:mt-12 mb-6 sm:mb-8 px-2">
        Let’s Make Your Business the Biggest Duck in the Pond!
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12 px-2 sm:px-4">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left px-2 sm:px-0">
          ...
          <ul className="list-disc list-inside mt-3 sm:mt-4 text-left text-base sm:text-lg space-y-2">
            ...
            <li className="mb-2">
              <strong> More Sales </strong> <br /> Outperform competitors in
              your niche
            </li>
          </ul>
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12 p-4 sm:p-6 mt-8 sm:mt-12">
        ...
        <div className="md:w-1/2 flex justify-center order-1 md:order-2">
          {/* <img
            src="https://duckdao.io/wp-content/uploads/2023/02/Duck3.svg"
            alt="Duck Olivia"
